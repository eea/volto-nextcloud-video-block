...
### [3.0.2](https://github.com/eea/volto-nextcloud-video-block/compare/3.0.1...3.0.2) - 28 April 2026

#### :bug: Bug Fixes

- fix: resolve preview_image on reload to prevent "[object Object]" request [Claudia Ifrim - [`1621c92`](https://github.com/eea/volto-nextcloud-video-block/commit/1621c92f2e058bc164a542320dbe56c778a107de)]

#### :hammer_and_wrench: Others

- fix failed test with proper preview_image fixture [Claudia Ifrim - [`ed7a42b`](https://github.com/eea/volto-nextcloud-video-block/commit/ed7a42bc0225426817739592c6809f32135558c2)]
### [3.0.1](https://github.com/eea/volto-nextcloud-video-block/compare/3.0.0...3.0.1) - 9 April 2026

#### :bug: Bug Fixes

- fix: make test [Alin V. (Claudiu) - [`950c414`](https://github.com/eea/volto-nextcloud-video-block/commit/950c41408cf068f735df08d63f9a826768bd95b1)]

## [3.0.0](https://github.com/eea/volto-nextcloud-video-block/compare/2.0.1...3.0.0) - 25 March 2026

#### :rocket: New Features

- feat: Volto 18 support - refs #287700 [Alin Voinea - [`e2d1247`](https://github.com/eea/volto-nextcloud-video-block/commit/e2d1247ca410ce9f580ae4f9ff8bb843ec2bf10e)]

#### :house: Internal changes

- chore: [JENKINSFILE] add package version in sonarqube [valentinab25 - [`bd13c2b`](https://github.com/eea/volto-nextcloud-video-block/commit/bd13c2b059031abf6e120e03bc5ba66236e5930e)]
- chore: [JENKINSFILE] use sonarqube branches [EEA Jenkins - [`96f4af6`](https://github.com/eea/volto-nextcloud-video-block/commit/96f4af67c500b8df1810c21dbcaebf0c1f0ed159)]

#### :hammer_and_wrench: Others

- tests: Fix Sonar Qube tags - refs #297339 [Alin Voinea - [`de8d70e`](https://github.com/eea/volto-nextcloud-video-block/commit/de8d70e15248991bc2e23ad87dc01c2dd52c8849)]
### [2.0.1](https://github.com/eea/volto-nextcloud-video-block/compare/2.0.0...2.0.1) - 27 November 2025

## [2.0.0](https://github.com/eea/volto-nextcloud-video-block/compare/1.0.0...2.0.0) - 28 July 2025

#### :boom: Breaking Change

- breaking(images): use image scales from restapi refs #254622 #16 from eea/image_scales [David Ichim - [`9ad0044`](https://github.com/eea/volto-nextcloud-video-block/commit/9ad00444c39dc5011dd0b9b6ebbbe17335d285e6)]

#### :bug: Bug Fixes

- fix: preview_image [nileshgulia1 - [`49e1bf5`](https://github.com/eea/volto-nextcloud-video-block/commit/49e1bf55a24d66e5c14a3a03faec37da5df2a92e)]
- fix: url when string [nileshgulia1 - [`6e19324`](https://github.com/eea/volto-nextcloud-video-block/commit/6e1932474014555f36acbbe1baf6dbd64ed1e074)]
- fix: preview images and external image source [nileshgulia1 - [`9ce8c01`](https://github.com/eea/volto-nextcloud-video-block/commit/9ce8c01090af22d43a6447d91765e4f013211acf)]

#### :house: Internal changes

- chore: package.json [alin - [`8dd56a9`](https://github.com/eea/volto-nextcloud-video-block/commit/8dd56a9cf142bc3267a3ce06304e185f93470ba1)]
- chore(release): use * for volto-object-widget instead of develop branch [David Ichim - [`3296c3f`](https://github.com/eea/volto-nextcloud-video-block/commit/3296c3f5e26614b418e82c1cc08f794f8f8821e0)]
- chore: package.json [Alin Voinea - [`2531d6e`](https://github.com/eea/volto-nextcloud-video-block/commit/2531d6e8eded4db5614a372195c9b04e989d615d)]

#### :hammer_and_wrench: Others

- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`559a60a`](https://github.com/eea/volto-nextcloud-video-block/commit/559a60a3bd17accbdad0ed165d1649295035ddbc)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`0735521`](https://github.com/eea/volto-nextcloud-video-block/commit/07355213754de9e3f9c266951ded00fc21e1d25b)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`b80294b`](https://github.com/eea/volto-nextcloud-video-block/commit/b80294b61921d80c8033f3c67ef0157df3a78493)]
- add copilot suggestion to use useRef instead of createRef [David Ichim - [`476868d`](https://github.com/eea/volto-nextcloud-video-block/commit/476868d780acfcd81f69ee9102b531afc068c185)]
- Fix test due to missing getFieldUrl mock [David Ichim - [`865c487`](https://github.com/eea/volto-nextcloud-video-block/commit/865c487d56e6064241015a073728c12017820455)]
- Bump package version to major update and drop check for volto 16 to avoid getFieldUrl error [David Ichim - [`b696ca1`](https://github.com/eea/volto-nextcloud-video-block/commit/b696ca1c4b49bfb5743b70b2af36c9a6cc473c18)]
- Switch preview_image to attachedimage widget, merged changes from develop and dropped getImageScaleParams in favor of the import from volto-object-widget [David Ichim - [`ffdc127`](https://github.com/eea/volto-nextcloud-video-block/commit/ffdc127668ce5466cb936b06dde151847c09c0ee)]
- Merge changes from develop [David Ichim - [`789dedc`](https://github.com/eea/volto-nextcloud-video-block/commit/789dedc4d3b71d28a5665bd949c9572b97c02cb2)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`b4eab67`](https://github.com/eea/volto-nextcloud-video-block/commit/b4eab677184331e0c50926243c9c365d4bfa81c9)]
- Add Sonarqube tag using ied-frontend addons list [EEA Jenkins - [`248c0aa`](https://github.com/eea/volto-nextcloud-video-block/commit/248c0aaa7f807377bf193333be494f63e8086784)]
- test: one last test case [nileshgulia1 - [`e634620`](https://github.com/eea/volto-nextcloud-video-block/commit/e634620b30a34b283c4c370f5b156c60f95c48fc)]
- add more tests [nileshgulia1 - [`45b441b`](https://github.com/eea/volto-nextcloud-video-block/commit/45b441bb14dab8d3c056830c2bc94b3def80cf49)]
- tests: cover more cases [nileshgulia1 - [`b9b971a`](https://github.com/eea/volto-nextcloud-video-block/commit/b9b971a0c3acf7bbbdb87be5c1b423c3bf79da68)]
- tests: more specs to increase coverage [nileshgulia1 - [`53b6902`](https://github.com/eea/volto-nextcloud-video-block/commit/53b69021de93f008ad50231e43012c8510138fac)]
- test: add missing tests [nileshgulia1 - [`14d0b73`](https://github.com/eea/volto-nextcloud-video-block/commit/14d0b73a60b502db8457b8a80b971533a5ab1be9)]
- fix cypress undefined error [nileshgulia1 - [`15de090`](https://github.com/eea/volto-nextcloud-video-block/commit/15de090c71a318731c90ea4a8e97c0b60b6c21a0)]
- use image scales from restapi refs#254622 [nileshgulia1 - [`364391c`](https://github.com/eea/volto-nextcloud-video-block/commit/364391c146e3c959705bafc7ffae835b0566e5a7)]
...
- chore: [JENKINS] Refactor automated testing [valentinab25 - [`d5f161a`](https://github.com/eea/volto-nextcloud-video-block/commit/d5f161a408f286443c1a12a45368bc8459c7101b)]

#### :hammer_and_wrench: Others

- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`0b2777a`](https://github.com/eea/volto-nextcloud-video-block/commit/0b2777ac9f985e6f1fe626b4cf6d2da89063159b)]
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`ec4955b`](https://github.com/eea/volto-nextcloud-video-block/commit/ec4955b7f756f0a13377664389355ba1c63c640c)]
- test: [JENKINS] Use java17 for sonarqube scanner [valentinab25 - [`32f5c07`](https://github.com/eea/volto-nextcloud-video-block/commit/32f5c07116a7ba23bd0aeca8bd1d3c4aab3412ea)]
- test: [JENKINS] Run cypress in started frontend container [valentinab25 - [`2506c8f`](https://github.com/eea/volto-nextcloud-video-block/commit/2506c8f916e63abe9147e4c4c918cfafbf53ba41)]
- test: [JENKINS] Add cpu limit on cypress docker [valentinab25 - [`82466ad`](https://github.com/eea/volto-nextcloud-video-block/commit/82466adbca28cd9d24167df1d4b4e44676cb0e33)]
- test: [JENKINS] Increase shm-size to cypress docker [valentinab25 - [`5457da6`](https://github.com/eea/volto-nextcloud-video-block/commit/5457da6650ddea0701aab58c0983e35760f61fcb)]
- test: [JENKINS] Improve cypress time [valentinab25 - [`30f6808`](https://github.com/eea/volto-nextcloud-video-block/commit/30f680859853409ffdbbd825b59d39a5629757f3)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`e45576b`](https://github.com/eea/volto-nextcloud-video-block/commit/e45576b296d6f0623289e8863a031df5737d7b86)]
